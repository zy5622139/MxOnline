...
class Course(models.Model):
    ...
    image = models.ImageField(upload_to='image/course/%Y/%m', max_length=100, verbose_name=u'封面图')
    ...
    course_tell = models.CharField(max_length=100, verbose_name=u'课程公告', default='')
    teacher_tell = models.CharField(max_length=100, verbose_name=u'老师的话', default='')
...
class Lesson(models.Model):
    ...
    name = models.CharField(max_length=100, verbose_name=u'课程章节')
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u'添加时间')
...
class Video(models.Model):
    ...
    name = models.CharField(max_length=100, verbose_name=u'课程视频')
...
class CourseResource(models.Model):
    ...
    download_file = models.FileField(upload_to='image/course_resource/%Y/%m', verbose_name=u'资源文件', max_length=100)
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u'添加时间')
